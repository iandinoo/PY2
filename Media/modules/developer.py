...
__Please select the menu you want to {} use.__
"""
...
async def menu(client, message):
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("+ Set Force", callback_data="setforce"),
            InlineKeyboardButton("+ Set Logger", callback_data="setlogger"),
        ],
        [
            InlineKeyboardButton("+ Set Welcome", callback_data="setwelcome"),
            InlineKeyboardButton("+ Set TextTwo", callback_data="settexttwo"),
        ],
        [
...
async def callback_two(client, callback_query):
    keyboard = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("📢 Broadcast", callback_data="toggle_broadcast"),
        ],
        [
            InlineKeyboardButton("🛠️ Maintenance", callback_data="toggle_maintenance"),
        ],
        [
            InlineKeyboardButton("📜 On/Off Logger", callback_data="toggle_logger"),
        ],
        [
            InlineKeyboardButton("✊ On/Off Force", callback_data="toggle_force"),
        ],
        [
